...
- name: Buffer Get Updates Interactions Mediatypeextension
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/actions/master/_listings/buffer/updatesidinteractionsmediatypeextension-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/actions/master/_listings/buffer/updatesidinteractionsmediatypeextension-get-openapi.md
- name: Buffer
  x-api-slug: buffer
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/actions/master/_listings/buffer/openapi.md
x-common:
- type: x-base
