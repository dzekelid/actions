...
- name: AWS Elastic MapReduce API - List Bootstrap Actions
  ...
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/actions/master/_listings/aws-elastic-mapreduce/actionlistbootstrapactions-get-openapi.md
x-common:
- type: x-api-gallery
