...
apis:
- name: BMC Software Merged API - Get all available action types
  x-api-slug: v1actions-get
...
- name: BMC Software Merged API - Get all installed actions
  x-api-slug: v1actionsinstalled-get
...
- name: BMC Software Merged API - Install action
  x-api-slug: v1actionsinstalled-put
...
- name: BMC Software Merged API - Get details of an installed action
  x-api-slug: v1actionsinstalledactionid-get
...
- name: BMC Software Merged API - Get all alarms using an action
  x-api-slug: v1actionsinstalledactionidalarms-get
...
- name: BMC Software Merged API - Uninstall action
  x-api-slug: v1actionsinstalledactionid-delete
...
- name: BMC Software Merged API - Get action
  x-api-slug: v1actionsaction-get
